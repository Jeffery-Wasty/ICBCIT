...
best_clf = xgb.XGBClassifier(objective='binary:logistic', seed=90, num_round=num_boost_rounds, subsample=0.8, scale_pos_weight=3,
                        reg_alpha=1e-05, n_estimators=180, min_child_weight=2, max_depth=12, learning_rate=0.1, gamma=0.5, colsample_bytree=0.7)
...
export.to_csv('category_true_test_xgb_4.csv')
