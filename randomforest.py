...
testSet = pd.read_csv("category_best_model.csv")
...
random_grid = {'n_estimators': range(60, 170),
...
#clf = RandomizedSearchCV(estimator=rf, param_distributions=random_grid, n_iter=20, cv=3, verbose=1, random_state=454, n_jobs=-1)
